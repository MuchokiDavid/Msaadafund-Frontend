      ...
      <div id="slide3" className="carousel-item relative w-full h-56">
        ...
        <div>
          <div className="absolute inset-0 flex flex-col items-center justify-center align-middle px-4">
            <h1 className="text-2xl lg:text-4xl text-gray-800 font-bold text-center my-4">
              Pricing plans
            </h1>
            <div className="text-center">
              <p className="text-gray-800">
                This pricing guide provides information about the payment
                charges incurred by the organisers.
                <br />
