            ...
            <div className="h-full lg:w-2/3">
              <div className="bg-white border mt-6 p-6 rounded-lg shadow-sm">
                ...
                <div className="mb-8">
                  ...
                  <p className="mt-2 text-lg text-gray-600">
                    Have questions or feedback? We'd love to hear from you! Reach out to us at <a href="mailto:info@msaaadafund.com" className="text-blue-600">info@msaaadafund.com</a>.
                  </p>
                </div>
                <div>
