...
const handleSendOTP = async () => {
  try {
    await axios.post('https://backend.service.msaadafund.com/home/api/v1.0/forgot_password', { email });
...
const handleResetPassword = async () => {
  try {
    ...
    await axios.patch('https://backend.service.msaadafund.com/home/api/v1.0/reset_password', { email, otp, new_password: newPassword });
