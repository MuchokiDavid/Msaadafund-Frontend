        ...
        <>
            <div className="navbar bg-white top-0 shadow-md z-20">
                ...
                <div className="navbar-end">
                    ...
                    :
                    (<div className="dropdown dropdown-end absolute right-4 sm:z-20">
                    <div tabIndex={0} role="button" className="text-white border border-blue-600 bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</div>
