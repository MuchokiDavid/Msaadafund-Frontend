...
function Menus() {
    ...
    return (
        <>
            <div className="navbar bg-slate-700 fixed top-0 z-10">
                ...
                <div className="navbar-end">
                    ...
                    <div tabIndex={0} role="button" className="btn m-1 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Log in</div>
