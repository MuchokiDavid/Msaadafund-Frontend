...
function ResetPass() {
  ...
  const handleSendOrgOTP = async () => {
    try {
      await axios.post('https://backend.service.msaadafund.com/home/api/v1.0/org_forgot_password', { email });
  ...
  const handleResetOrgPassword = async () => {
    try {
      ...
      await axios.patch("https://backend.service.msaadafund.com/home/api/v1.0/org_reset_password", { email, otp, new_password: newOrgPassword });
