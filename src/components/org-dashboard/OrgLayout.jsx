  ...
  return (
    <div className='overflow-hidden'>
      ...
      <div className="flex relative">
        ...
        <main className={`mt-3 mx-auto w-full overflow-hidden overflow-y-auto md:m-3 min-h-screen sm:w-full justify-center px-2 lg:px-6 ${isSmallScreen && isSidebarOpen ? 'blur' : ''}`} style={{ marginTop: '10px' }} id='dashboard'>
          <Routes>
