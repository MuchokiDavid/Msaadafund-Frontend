    ...
    <div className="mx-3">
      <div className="text-sm breadcrumbs ml-2">
        <ul>
          ...
          <li>
            <a href="/org/dashboard/transact/buyairtime">Buy Airtime</a>
          </li>
        </ul>
      </div>
      <div>
          ...
          <aside className="">
            <div className="p-4 rounded">
              ...
              <ul className="list-disc mt-3 list-inside text-xs">
                ...
                <li>
                  Double-check the amount you wish to purchase and make sure it
                  is more than sh.5 to avoid errors.
                </li>
                <li>
                  Once you submit the purchase request, This will initialize the
