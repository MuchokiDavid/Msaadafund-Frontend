...
function Donations({ allCampaigns, campaignError, allDonors }) {
    ...
    const filtered =
      ...
      allDonations.filter((donation) => {
        ...
        const campaign = campaigns.find(
          (campaign) => campaign.id === donation.campaignId
        );
  ...
  const handleExcel = () => {
    ...
    XLSX.writeFile(
      wb,
      `msaaadafund_donations_${new Date().toLocaleDateString()}.xlsx`
    );
  };
    ...
    <div>
      <div className="text-sm breadcrumbs ml-2">
        <ul>
          ...
          <li>
            <a href="/org/dashboard/donations">Contributions</a>
          </li>
        </ul>
      </div>
      <h1 className="mb-1 my-2 text-2xl font-bold leading-tight ">
        Contributions
      </h1>
      <hr />
          ...
          <div className="flex flex-col mt-1">
            <div className="flex justify-between py-2">
              ...
              <div className="mr-2 py-2">
                <select
                  className="py-2 rounded bg-white text-gray-800"
                  ...
                  {paginatedDonations.map((donation) => {
                    ...
                    return (
                      <tr key={donation._id} className="even:bg-blue-50">
                        <td className="px-2 py-1 whitespace-no-wrap border-b border-gray-200 ">
                          {donation.invoice_id}
                        </td>
                        <td className="px-2 py-1 whitespace-no-wrap border-b border-gray-200 ">
                          {campaignTitle}
                        ...
                        <td className="px-2 py-1 whitespace-no-wrap border-b border-gray-200 ">
                          {moment(donation.donationDate).format(
                            "dddd Do MMMM, YYYY"
                          )}
                        </td>
        ...
        <div className="grid grid-cols-1 gap-4 mt-3 px-4">
          <div>
            <p className="text-red-500">
              No contributions to display. Create campaign to start receiving
              contributions
            </p>
          </div>
          <div>
