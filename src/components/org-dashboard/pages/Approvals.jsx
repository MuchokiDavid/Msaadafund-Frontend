...
function Approvals() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${apiUrl}/api/v1.0/org_awaiting_approvals`, config)
      .then((res) => {
    ...
    <div>
      <div className="text-sm breadcrumbs ml-2">
        <ul>
          ...
          <li>
            <a href="/org/dashboard/transact/approvals">Pending approvals</a>
          </li>
        </ul>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="table table-xs text-xs bg-white">
          <thead className="text-balance text-gray-800 bg-gray-100">
            <tr>
              <th className="px-3 py-3 font-medium leading-4 tracking-wider text-leftuppercase border-b border-gray-200 ">
                Id
              </th>
              <th className="px-3 py-3 font-medium leading-4 tracking-wider text-leftuppercase border-b border-gray-200 ">
                Recipient
          ...
          <tbody>
            ...
            {transactions &&
              transactions.map((transaction) => (
                <tr key={transaction.id} className="border-t even:bg-blue-50">
