    ...
    <div className="mx-3">
      <div className="text-sm breadcrumbs ml-2">
        <ul>
          ...
          <li>
            <a href="/org/dashboard/transact/till">Buy goods and services</a>
          </li>
        </ul>
      </div>
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 border rounded-lg bg-white">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-4">
              <label className="block font-semibold mb-1" htmlFor="name">
                <span className="text-red-500">*</span>Till Number
              </label>
              <input
            ...
            <div className="mt-4">
              <label className="block font-semibold mb-1" htmlFor="number">
