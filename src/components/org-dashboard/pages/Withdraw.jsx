    ...
    <div>
      <div className="text-sm breadcrumbs ml-2">
        <ul>
          ...
          <li>
            <a href="/org/dashboard/transact/withdraw">Withdraw</a>
          </li>
        </ul>
      </div>
      <div>
              ...
              <div className="stats border">
                <div className="stat bg-white text-gray-800">
                  ...
                  <div className="stat-value">
                    {walletDetails && walletDetails.currency}{" "}
                    {walletDetails && walletDetails.available_balance}
                  </div>
                </div>
              </div>
            ) : null}
            ...
            <div className="mt-4">
              ...
              >
                ...
                {accountNumbers.map((accountNo, index) => {
                  return (
                    <option value={accountNo.accountNumber} key={index}>
            ...
            <div className="modal-box bg-white">
              ...
              {transactionResponse.transactions && (
                <p className="text-emerald-500">
                  Status: {transactionResponse.transactions[0].status}
                </p>
              )}
              ...
              >
                <div className="flex-col justify-center items-center pl-4 pr-8 text-left">
                  <div className="my-4 text-white">
                    <label
                      className="font-semibold my-3 text-gray-700"
                      htmlFor="amount"
                    >
                      Amount
                    </label>
                  ...
                  <div>
                    <label className="font-semibold mb-4" htmlFor="password">
                      <span className="text-red-500">*</span>Enter Pin
                    </label>
                    <input
                    ...
                    <button
                      ...
                      className="absolute right-14 mx-1 mt-4   "
                    >
                      {passswordShow ? <FaEye /> : <FaEyeSlash />}
                    </button>
                  </div>
                  <div>
                    <button
                      type="submit"
                      className="rounded-md px-5 py-2 bg-blue-600 text-white my-4 min-w-full"
                    >
                      Withdraw
                    </button>
                  </div>
          ...
          <aside className="">
            <div className="bg-white px-6 rounded">
              ...
              <ul className="list-disc list-inside text-xs">
                <li>
                  Ensure you have added your signatories{" "}
                  <span className="text-blue-600 font-semibold underline">
                    <a href="/org/dashboard/transact/signatories">here</a>
                  </span>
                </li>
                <li>
                  Register your withdrawal account{" "}
                  <span className="text-blue-600 font-semibold underline">
                    <a href="/org/dashboard/transact/accounts">here</a>
                  </span>
                </li>
                ...
                <li>
                  Enter your withdrawal pin to complete the withdrawal process.
                </li>
                <li>
                  Once you submit the payment request, This will initialize the
                  transaction which requires atleast 3 signatories to be
                  completed
                </li>
              </ul>
