...
function Withdrawals() {
    ...
    const filteredWithdrawals =
      ...
      allWithdrawals.filter((withdrawal) => {
        return (
          ...
          (withdrawal.org_name &&
            withdrawal.org_name.toLowerCase().includes(search.toLowerCase())) ||
  ...
  useEffect(() => {
    ...
    axios
      .get(`${apiUrl}/api/v1.0/withdraw_transactions`, config)
      .then((res) => {
        setLoading(false);
  ...
  const handleExcel = () => {
    ...
    XLSX.writeFile(
      wb,
      `msaaadafund_withdrawals_${new Date().toLocaleDateString()}.xlsx`
    );
  };
    ...
    <div>
      <div className="text-sm breadcrumbs ml-2">
        <ul>
          ...
          <li>
            <a href="/org/dashboard/transact/withdrawals">Withdrawals</a>
          </li>
        </ul>
      </div>
      <div>
          ...
          <table className="table table-xs bg-white">
            <thead className="text-gray-800 bg-gray-100 text-left uppercase">
              <tr className="text-gray-800 bg-gray-100">
                <th className="px-2 py-3 font-medium leading-4 tracking-wider text-left uppercase border-b border-gray-200 ">
                  Tracking id
                </th>
                <th className="px-2 py-3 font-medium leading-4 tracking-wider text-left uppercase border-b border-gray-200 ">
                  Name
