        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-6 border rounded-lg">
            <div>
                ...
                <div className="flex items-center justify-between mt-4">
                    <button className="flex items-center justify-center px-6 py-2 border border-blue-600 text-base font-medium rounded-md text-white bg-blue-600 hover:bg-transparent hover:text-gray-900" onClick={handleFetch}>{loading ? "Checking" :"Check Status"}</button>
                </div>
        ...
        <div className=' bg-white border rounded-lg p-4 mt-2'>
            ...
            <div className="flow-root rounded-lg border border-gray-100 py-3 shadow-sm mt-4">
                <dl className="-my-3 divide-y divide-gray-100 text-sm">
                    ...
                    <dd className="text-gray-700 sm:col-span-2">{statusResponse && statusResponse ? statusResponse.tracking_id : <p>..................</p>}</dd>
                    </div>
                    <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                    <dt className="font-medium text-gray-900">Transaction Id</dt>
                    <dd className="text-gray-700 sm:col-span-2">{statusResponse && statusResponse.transactions ? statusResponse.transactions[0].transaction_id: <p>..................</p>}</dd>
                    </div>

                    <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                    <dt className="font-medium text-gray-900">Transaction status</dt>
                    <dd className="text-gray-700 sm:col-span-2">{statusResponse && statusResponse.transactions ? statusResponse.transactions[0].status: <p>..................</p>}</dd>
                    </div>

                    <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                    <dt className="font-medium text-gray-900">Provider</dt>
                    <dd className="text-gray-700 sm:col-span-2">{statusResponse && statusResponse.transactions ? statusResponse.transactions[0].provider: <p>..................</p>}</dd>
                    </div>

                    <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                    <dt className="font-medium text-gray-900">Name</dt>
                    <dd className="text-gray-700 sm:col-span-2">{statusResponse && statusResponse.transactions ? statusResponse.transactions[0].name: <p>..................</p>}</dd>
                    </div>

                    <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                    <dt className="font-medium text-gray-900">Amount</dt>
                    <dd className="text-gray-700 sm:col-span-2">{statusResponse && statusResponse.transactions ? statusResponse.transactions[0].amount: <p>..................</p>}</dd>
                    </div>
                    <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                    <dt className="font-medium text-gray-900">Account</dt>
                    <dd className="text-gray-700 sm:col-span-2">{statusResponse && statusResponse.transactions ? statusResponse.transactions[0].account: <p>..................</p>}</dd>
                    </div>
                    <div className="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                    <dt className="font-medium text-gray-900">Batch Status</dt>
                    <dd className="text-gray-700 sm:col-span-2">{statusResponse && statusResponse ? statusResponse.status : <p>..................</p>}</dd>
                    </div>
                </dl>
            </div>
        </div>
