        ...
        <div className="grid grid-cols-1 gap-4 mt-2 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3">
            <div className="flex items-center rounded-md overflow-auto bg-green-800 px-2 py-4 border">
                ...
                <div className="px-2 text-white justify-between items-center">
                    <div>
                        <h3 className="tracking-wider text-sm lg:text-base">Total Donations</h3>
                    </div>
                    <div>
            ...
            <div className="flex items-center rounded-md overflow-auto bg-blue-400 px-2 py-4 border">
            ...
            <div className="flex items-center bg-emerald-500 rounded-md overflow-auto px-2 py-4 border">
