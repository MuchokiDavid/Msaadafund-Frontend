  ...
  return (
    <div className='px-4 pb-4'>
        ...
        <div className="grid grid-cols-1 gap-4 mt-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 sm:px-8">
            <div className="flex items-center bg-transparent border rounded-sm overflow-auto bg-emerald-100">
            ...
            <div className="flex items-center bg-transparent border rounded-sm overflow-auto bg-blue-100">
