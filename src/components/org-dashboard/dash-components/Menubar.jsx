...
function Menubar({handleMenuItemClick}) {
  ...
  return(
    <>
  <aside className="flex flex-col min-w-64 min-h-screen pl-5 py-2 overflow-y-auto bg-white text-sky-950 border-r rtl:border-r-0 rtl:border-l overflow-x-hidden">
