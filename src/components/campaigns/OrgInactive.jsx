...
function OrgInactive({organisationDetails}) {
  ...
  return (
    <div className='py-4'>
        ...
        {/* -------------------------------------Cards for campaign--------------------------------------- */}
        {expiredCampaigns.length === 0 ? <div className="text-base mx-4 mb-6">No Finished campaigns</div> : null}
        <div className="mx-2 sm:mx-1 lg:mx-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4 sm:gap-2 md:gap-4 sm:max-w-full">
