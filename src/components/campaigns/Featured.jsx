                        ...
                        <div className="mt-2 px-2 pb-4">
                          <dl>
                            ...
                            <div>
                              ...
                              <dd><a href={`/organisations/${campaign.organisation.orgName}`} className='text-blue-700 hover:underline whitespace-nowrap'>Organiser: {campaign.organisation.orgName}</a></dd>
