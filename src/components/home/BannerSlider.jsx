  ...
  return(
    <div className="relative bg-cover bg-center h-screen flex items-center justify-center object-fill" 
      ...
      <div className="relative z-10 text-center text-white px-6">
        ...
        <a href="/campaigns" 
           className="bg-transparent hover:bg-blue-600 text-blue-600 hover:text-white text-white border border-blue-600 font-semibold py-3 px-8 rounded-lg transition duration-300 ease-in-out">
