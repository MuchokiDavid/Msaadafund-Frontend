...
function Banner() {
  ...
  return (
    <div className="text-gray-900">
      ...
      <section>
        <div className="mx-auto max-w-screen-xl px-4 my-6 sm:px-6 sm:my-6 lg:px-8 lg:my-6">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:py-20">
              ...
              <p className="mt-4 text-gray-600">
                MsaadaFund is designed for effortless use on any device—whether
                you're on your phone, tablet, or laptop. Enjoy a smooth and
                intuitive experience as you explore, support, and share
                campaigns. Our platform makes it easy to contribute to causes
                you care about, anytime and anywhere.
              </p>
              <a
                href="/campaigns"
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Explore a diverse array of fundraising campaigns from
                  organizations. Find a cause that speaks to you and get
                  involved.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Make your contribution to the campaign that inspires you.
                  Every contribution, big or small, helps us reach our goals and
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Amplify the reach of the campaigns by sharing them with your
                  network. Your advocacy can motivate others to join and support
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Have a cause you’re passionate about? Start your own campaign
                  with MsaadaFund. Use our tools to set up, promote, and manage
                  your campaign and engage the community.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Build relationships with organizations driving meaningful
                  change. Explore their initiatives and collaborate to enhance
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Follow the progress of the campaigns you support. Receive
                  updates on key milestones, fund usage, and the positive
                  changes your contribution is driving.
                </p>
              </div>
            </div>
          </div>
      ...
      <section>
        <div class="mt-12 px-4 sm:px-10 bg-blue-100">
          <div class="min-h-[400px] relative h-full max-w-4xl mx-auto flex flex-col justify-center items-center text-center px-6 py-16">
            ...
            <p>
              Ready to make a difference? Join MsaadaFund and empower your
              fundraising efforts. Whether you're a seasoned fundraiser or new
              to the world of fundraising, our platform is designed to help you
              succeed. Start your journey today and turn your passion into
              success!
            </p>

            <Link to="/org/signup">
              <button class="bg-blue-500 hover:bg-blue-600 text-white flex items-center transition-all font-semibold rounded-md px-5 py-4 mt-8">
                Get started
                <svg
