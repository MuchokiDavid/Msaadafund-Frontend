            ...
            <div className="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-16 max-w-7xl lg:py-20">
                ...
                <div className="relative inline-flex items-center mx-auto align-middle">
                    ...
                    <div className="flex justify-center w-full max-w-2xl gap-2 mx-auto mt-6">
                        ...
                        <button className="mt-2 inline-block rounded border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-gray-900 focus:outline-none focus:ring focus:ring-blue-400">Fundraisers</button>
                        </div>
                        <div className="mt-3 rounded-lg sm:mt-0 sm:ml-3">
                        <button className="mt-2 inline-block rounded border border-blue-600 hover:bg-blue-600 px-12 py-3 text-sm font-medium hover:text-white transition bg-transparent text-gray-900 focus:outline-none focus:ring focus:ring-blue-400">Organisations</button>
                        </div>
                    </div>
                    </div>
                </div>
