  ...
  return (
    <div>      
      ...
      {isSidebarOpen && <Usermenubar isOpen={isSidebarOpen} toggleSidebar={toggleSidebar} handleMenuItemClick= {handleMenuItemClick}/>}
        ...
        <UserNav toggleSidebar={toggleSidebar} handleMenuItemClick = {handleMenuItemClick}/>
        <main className={`flex-1 text-gray-800 mt-3 mx-auto overflow-y-auto md:m-3 h-screen justify-center px-2 lg:px-6`} style={{ marginTop: '10px' }} id='userdashboard' onClick={handleMenuItemClick}>
          <Routes>
